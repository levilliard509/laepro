...
import { InstitutionModel, UserModel } from '../models/institution-model';
import { AddressModel } from '../models/address-model';

export class AppSettings {
  
	//public static URL_BASE = "http://192.168.43.47:8080/laepro/laepro";	  
	  public static URL_BASE = "http://localhost:8080/laepro/laepro";
  	public static LANGUAGE = "ENG";
	  public static CURENCY_CHANGE = "HTG";
  	public static INSTITUTION = new InstitutionModel();
  	public static ADDRESS = new AddressModel();
